...
<a href="{{ site.proj_url }}/assets/SGDvGD.svg"><img src="{{ site.proj_url }}/assets/SGDvGD.svg"></a>
...
<script src="{{ site.proj_url }}/js/slider.js"></script>
<script src="{{ site.proj_url }}/js/svm-vis.js"></script>
...
<table>
    ...
    <tr>
        <td>RCV1</td>
        <td><a href="{{ site.proj_url }}/assets/rcv1-error.png"><img src="{{ site.proj_url }}/assets/rcv1-error.png"></a></td>
        <td><a href="{{ site.proj_url }}/assets/rcv1-accuracy.png"><img src="{{ site.proj_url }}/assets/rcv1-accuracy.png"></a></td>
    </tr>
    <tr>
        <td>EPSILON</td>
        <td><a href="{{ site.proj_url }}/assets/epsilon-error.png"><img src="{{ site.proj_url }}/assets/epsilon-error.png"></a></td>
        <td><a href="{{ site.proj_url }}/assets/epsilon-accuracy.png"><img src="{{ site.proj_url }}/assets/epsilon-accuracy.png"></a></td>
    </tr>
</table>
