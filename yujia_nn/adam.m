...
for t = 1:T-1
    ...
    Grms1 = 0.9*Grms1 + 0.1*(2 * (x_rms1(t))).^2;
    Grms2 = 0.9*Grms2 + 0.1*(50 * (x_rms2(t))).^2;
    x_rms1(t+1) = x_rms1(t) - 0.03 * (2 * (x_rms1(t)))/(sqrt(Grms1) + 1e-7);
    x_rms2(t+1) = x_rms2(t) - 0.03 * (50 * (x_rms2(t)))/(sqrt(Grms2) + 1e-7);    
   
    madam1 = 0.9*madam1 + 0.1*(2*x_adam1(t));
    madam2 = 0.9*madam2 + 0.1*(50*x_adam2(t));
    vadam1 = 0.999*vadam1 + 0.001*(2*x_adam1(t))^2;
    vadam2 = 0.999*vadam2 + 0.001*(50*x_adam2(t))^2;
    mhat1 = madam1/(1-b1);
    mhat2 = madam2/(1-b1);
    vhat1 = vadam1/(1-b2);
    vhat2 = vadam2/(1-b2);
    ...
    legend('Contour','Optimal','Steepest Descent, eta=0.005', 'Momentum, mu=0.9, eta=0.005', 'Nesterov, mu=0.9, eta=0.005',  'RMSProp, eta=0.03, gamma=0.9', 'AdaGrad, eta=0.03', 'Adam, eta=0.03, b1=0.9, b2=0.999');
    pause(0.005);
    if (t == 1)
        pause(1);
    end
